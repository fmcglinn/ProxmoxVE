...
function update_script() {
  ...
  if [ "$UPD" == "2" ]; then
    ...
    # ALLOWED-RCE: Official HACS (Home Assistant Community Store) installer
  ...
  if [ "$UPD" == "3" ]; then
    ...
    # TODO-REVIEW: Why is FileBrowser needed for Home Assistant? Consider removing or localizing
    # ALLOWED-RCE: Official FileBrowser installer
